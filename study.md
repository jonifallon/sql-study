...
```md
[,...n]	Indicates the preceding item can be repeated n number of times.
...
```sh
dropdb mydb
there are also options you can include like --if-exists
```
...
```sql
DROP TABLE mytable
you can also add options if applicable
```
